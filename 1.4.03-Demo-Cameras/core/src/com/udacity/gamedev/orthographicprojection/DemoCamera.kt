...
class DemoCamera : InputAdapter() {
    ...
    private val overviewCamera: OrthographicCamera
    private val closeupCamera: OrthographicCamera
    private var inCloseupMode = true

    init {
        overviewCamera = OrthographicCamera()
        closeupCamera = OrthographicCamera()
    ...
    fun render(renderer: ShapeRenderer) {
        if (!inCloseupMode) {
            ...
            val poly = floatArrayOf(bottomLeft.x, bottomLeft.y, bottomRight.x, bottomRight.y, topRight.x, topRight.y, topLeft.x, topLeft.y)
    ...
    companion object {
        ...
        val TAG = DemoCamera::class.java.name

        private val SCALE_RATE = 100f
        private val MOVE_RATE = 100f
        private val ROTATION_RATE = 45f
        private val INITIAL_ZOOM = 0.5f
    }
