...
class ReciprocatingMotion : ApplicationAdapter() {
    ...
    override fun render() {
		...
		val elapsedNanoseconds = (TimeUtils.nanoTime() - creationTime).toFloat()
		...
		val elapsedPeriods = elapsedSeconds / CYCLE_TIME_PERIOD
		...
		val x = worldCenterX + MOVEMENT_DISTANCE * MathUtils.sin(MathUtils.PI2 * cyclePosition)
